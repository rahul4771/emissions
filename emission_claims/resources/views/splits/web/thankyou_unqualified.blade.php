    ...
    <div class="container ">
      <div class="row ">
        <div class="col-lg-10 offset-lg-1 col-12 mp0  text-center animated bounceInDown">
          <img src=" {{ $resourcePath }}img/tnq.png" alt="" class="hand-img animated zoomInUp">
          <!-- <h3 class="animated zoomInUp">We're Sorry!</h3>
          <p class="top_p">Unfortunately, your vehicle does not match the criteria for us to proceed at this time.</p> -->

          <h3 style="line-height: 38px;font-size: 23px;">
            @if($data['mainHead'])
              {{$data['mainHead']}}
              <br/>
            @endif
