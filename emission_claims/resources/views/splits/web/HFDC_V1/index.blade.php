          ...
          <form name="cust_info" id="cust_info" action="{{ $actionpage }}" method="post" class="pad-lef">
            ...
            <div class="row" id="slide6">
              ...
              <div class="col-lg-12 col-12 text-center">
                  <h1 class="animated bounceInDown">Enter Your Vehicle Registration To Start Your Check</h1>
                  <!-- <h3>Mercedes diesel owners may be entitled to £1000's. Time limitations apply. Act now.</h3> -->
                  <h3>Mercedes diesel owners may be entitled to £1000's. Act now.</h3>
              </div>

              <div class="form-section text-center">
                <div class="row" >
                  <div class="col-lg-12">
                    <h4>Enter Your Vehicle Registration To Start Your Check</h4>
                    <div class="row m-0 mb-2 carRegNo_wrap">
                      <div class="offset-lg-1 col-lg-10 col-12 p-0">
                        ...
                        <input type="text" class="crg_num" placeholder="e.g.ME12DAR" aria-label="CarRegNo"  name="carRegNo" id="carRegNo" value="">
                      </div>
                    ...
                    <div class="offset-lg-1 col-lg-10 mb-pd text-center" style="margin-bottom: 10px;">
                      <!-- <a href="javascript:void(0)" class="btn next011 regNextBtn" id="regNextBtn"><span>Start My Check >> <br> -->
                      <a href="javascript:void(0)" class="btn next011 regNextBtn" id="regNextBtn" ><span>Start My Check >> <br>
                      <img src="{{ $resourcePath }}img/clock.png" alt=""> <i>It only takes a minute</i></span></a>
                      <p style="margin-bottom: 0px !important; color: #000">Don't have your registration number handy?</p>
                      <input type="button" name="dont_rem" class="btn btn-remember next012" id="" value="Click Here to SKIP">                       
                    </div>        
                  </div>
                </div>
              </div>
                ...
                <fieldset class="second_step form-section" data-step="2" >
                  <div class="col-lg-12 col-12 text-center">
                    <div class="fieldset-inner text-center">
                      <!-- <h4 style="margin: 16px 0 20px !important;"> Did you purchase, finance or lease the vehicle in England or Wales?</h4> -->
                      <h4 style="margin: 16px 0 20px !important;">Did you purchase, finance or lease the vehicle in England or Wales between 2009 and 2018?</h4>
                      <div class="row custom_radio justify-content-center">
                        <div class="mr-25">
                          <input type="radio" class=" want_answer_yes" name="purchase_finance_lease" value="yes" id="named_tenant-yes">
                          <label class="label-text next02" for="named_tenant-yes"><span>Yes</span></label>
                        </div>
                        <div class="">
                          <input type="radio" class="want_answer_yes" value="no" name="purchase_finance_lease" id="named_tenant-no" data-toggle="modal" data-target="#diselgroup">
                          <label class="label-text next02" data-toggle="modal" data-target="#formModal"for="named_tenant-no"><span>No</span></label>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-12">
                ...
                <fieldset  class="third_step form-section" data-step="3">
                  <div class="col-lg-12 col-12 text-center">                                
                    ...
                    <div class="fieldset-inner">     
                      <h4>
                           Have you joined another Mercedes Emissions Claim?
                      </h4>               
                      <div class="row custom_radio justify-content-center">
                        <div class="mr-25">
                          <!-- <input type="radio" class=" want_answer_yes" value="no" name="joined_another_claim" id="litre diesel-no"> -->
                          <input type="radio" class=" want_answer_yes" value="no" name="joined_another_claim" id="litre diesel-no">
                          <label class="label-text next03" for="litre diesel-no"><span>No</span></label>
                        </div>
                        <div class="">
                          <!-- <input type="radio" class=" want_answer_yes" name="litre_diesel" value="yes" id="litre diesel-yes"> -->
                          <!-- <input type="radio" class=" want_answer_yes" name="joined_another_claim" value="yes" id="litre diesel-yes"> -->

                          <input type="radio" class="want_answer_yes" value="yes" name="joined_another_claim" id="litre diesel-yes">                          
                          <label class="label-text next03" for="litre diesel-yes"  data-toggle="modal" data-target="#formModal"><span>Yes</span></label>
                        </div>                            
                      </div>
                    </div>    
                    <div class="progress" style="height:25px;">
            ...
            <div class="ow" id="slide4" style="display: none;">
              <div class="col-lg-12 col-12 text-center">
                <h1>GREAT NEWS!</h1>
                <h2 style="color: #FEEF06;">It looks like you may have a valid claim.</h2>
              </div>
              <div class="col-lg-12 form-section">                                                
                <h4>Please enter your Date of Birth and PostCode</h4>  
                <p class="text-center"><i>We must verify your identity as part of our ethical and professional responsibilities. To save time and costs, please provide us with your date of birth so that we can conduct a digital identity check. <b>If you do not provide your date of birth, you will need to upload a photo ID and proof of address before you submit your claim.</b></i></p>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
                  <fieldset class="scheduler-border">
                    <legend class="scheduler-border"> Date Of Birth</legend>
                    <div class="row">
                ...
                <div class="col-lg-12 postdiv p-0">
                  <fieldset class="scheduler-border">
                    <legend class="scheduler-border">Enter Your Postcode</legend>
                    <div class="col-lg-12 p-0 form-group">
                      <input id="txtPostCode" name="txtPostCode" value="" type="text" class="form-control  hero-input" placeholder="Enter Your Postcode">                                            
                      <button id="postcodevalid" style="float:none;" class="findbutt fdbt-mob " type="button">Lookup Address</button>
                      <i class="validate " aria-hidden="true" style="display:none;"></i>
                ...
                <div class="col-lg-12 p-0 form-group text-center">
                  <input type="button" class="btn btn-next mrg-10" id="next04"  value="Next">
                </div>
              </div>
            </div>

              
            <div class="row" id="slide5" style="display:none;">
              <div class="col-lg-12 col-12 text-center">
                <h1>GREAT NEWS!</h1>
                <h2 style="color: #FEEF06;">It looks like you may have a valid claim.</h2>
              </div>
              <div class="col-lg-12 form-section">
                <h4>Please enter your details below to submit your claim</h4>   
                <div class=" form-group">                          
                ...
                <div class="col-lg-12 p-0">
                  <div class=" form-group email_wrap">
                    <div style="display: flex;width: 100%;position: relative;">
                      <input type="email" id="txtEmail" name="txtEmail" class="form-control" value=" " placeholder="Email Address">
                      <img src="{{ $resourcePath }}img/privacy.png" alt="" class="privacyimg">
                    </div>
                  ...
                  <div class=" form-group col-lg-12 p-0 telephone_wrap">
                    <div style="display: flex;width: 100%;position: relative;">  
                      <input type="tel" id="txtPhone" name="txtPhone" class="form-control" value="" placeholder="Mobile Phone Number">
                      <img src="{{ $resourcePath }}img/privacy.png" alt="" class="privacyimg">
                    </div>  
                    ...
                    <p class="alert-text"><strong>Mobile Phone</strong> is Recommended. Automated SMS are sent to keep you up-to-date throughout the claims process.</p>
                  </div>                                    
                </div>
                <div class="frmbtmcntnt">
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <h5 class="text-left">Please read and confirm the following:</h5>
                    </div>
                    <div class="col-lg-6 col-md-6 d-lg-block d-md-block d-none text-right">
                      <button type="button" class="btn btn-primary lrgbtn" data-toggle="modal" data-target="#CLAIMSModal" style="margin-bottom: 10px;">
                            Open larger version
                      </button>
                    </div>
                  </div>
                    ...
                    <div class="accordion" id="accordionExample">
                      ...
                      <div class="card">
                        ...
                        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                          <div class="card-body">
                            ...
                            <p>The Funding Agreement sets out the terms on which the Funder will advance the costs of the litigation on your behalf in accordance with the agreed budget and your agreement to pay the Funding Fee (being 40% of your damages and any unrecovered VAT on our Conditional Fees) if the claims are successful.

                                  •The Priorities Agreement explains how the claim proceeds will be allocated which sets out the payment to you of the agreed 60% of your damages aware less any unrecovered VAT on our conditional fees.</p>
                            ...
                            <p>that you have had the opportunity to take independent legal advice in relation to your participation in the claims;
                                  ...
                                  •to follow legal advice and to abide by the terms of the funder’s insurance, and it is important that you follow these obligations and comply with any requests from Hausfeld or the Committee or else you may be in breach of the funding agreement.</p>
                      ...
                      <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                          <div class="card-body">
                            ...
                            <p class="p11 ft8">Engagement letter: Proposed group claim in relation to Mercedes-Benz emissions</p><br><br>
                            <p class="p11 ft11"><span class="ft8">1.</span><span class="ft10">Introduction</span></p><br><br>
                            ...
                            <br><br>
                            <p class="p14 ft8">Litigation Management Agreement and Funding Agreement</p><br><br>
                            ...
                            <br><br>
                            <p class="p26 ft11">Agreement to participate in Group Claims</p><br><br>
                            ...
                            <br><br>
                            <p class="p58 ft42"><span class="ft8">6.</span><span class="ft40">Our Fees, Expenses and Disbursements </span><br><span class="ft41">Our Fees</span></p>
                            ...
                            <br><br>
                            <p class="p26 ft11"><span class="ft8">7.</span><span class="ft52">Sharing and allocation of costs with other Claimants</span></p><br>
                            ...
                            <br><br>
                            <p class="p130 ft79"><span class="ft8">14</span><span class="ft77">Cancellation and Termination </span><br><span class="ft78">Right of Cancellation for Consumers</span></p>
                            ...
                            <br>
                            <br>
                            <p class="p2 ft9"><br><br><br><br>
                            Nicola Boyle</p>
                            <p class="p2 ft9">Partner</p>
                            <p class="p2 ft3">For and on behalf of Hausfeld &amp; Co. LLP</p>
                            <br><br>
                            <p class="p2 ft9">Encl.</p><br><br><br><br><br>
                            <p class="p152 ft9">I agree to the terms of this retainer</p>
                            <span class="ft8">………………………………………………………………………………………………………………</span>
                            <p class="p154 ft9">Claimant</p>
                            <span class="ft8">Date……………………………………………………………………………………………………</span>
                            <p class="p156 ft84" style="text-align:center">Schedule One - Notice of the Right to Cancel</p><br><br>
                            ...
                            <div class="table-responsive noborder">
                              <table cellpadding="0" cellspacing="0" class="trr">
                                <tbody><tr>
                                        ...
                                        <td class="tr9 td14"><p class="p2 ft9"><input type="text" size="30"></p></td>
                                </tr>
                                <tr>
                                        <td class="tr8 td13"><p class="p2 ft9">Name (please print):</p></td>
                                        <td class="tr8 td14"><p class="p2 ft9"><input type="text" size="30"></p></td>
                                </tr>
                                <tr>
                                        <td class="tr10 td13"><p class="p2 ft9">Address:</p></td>
                                        <td class="tr10 td14"><p class="p2 ft9"><input type="text" size="30"></p></td>
                                </tr>
                                <tr>
                            ...
                            <br><br><p class="p26 ft8"><span class="ft9">12)</span><span class="ft90">Data protection</span></p>
                            ...
                            <p class="p6 ft7"><a href="fax:44(0)2076655001">44 (0)20 7665 5001</a> fax
                            </p>  
                            <div class="dclr"></div>
                            <div id="id38_1">
                              <p class="p286 ft8">
                              ...
                              <br><br>
                              <p class="p304 ft8" style="text-align:center">Amended Costs Provisions – Clauses 6, 8 and 9 of the Engagement Terms</p><br><br>
                              ...
                              <br><br>
                              <p class="p255 ft51">Payment of third-party disbursements and expenses</p><br><br>
                      ...
                      <div class="card">
                        ...
                        <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                          <div class="card-body">
                            <img src="{{ $resourcePath }}img/logo.jpg" alt=""><p class="p5 ft6">Confidential</p>
                  ...
                  <div class="col-lg-12 chiller_cb mt-3 mb-3">
                    <input id="readagree" name="readagree" type="checkbox" value="0" style="margin-top: 7px;">
                    <label for="readagree">I have read the Claims Summary and agree to the other documents</label>
                  ...
                  <div class="col-lg-12 p-0 form-group text-center">
                    <!--<a href="#">
                      ...
                      <input type="submit" class="btn regNextBtn mrg-10" id="Submitbutton" name="submit1"  value="Click To Submit Details">
                  </div>
