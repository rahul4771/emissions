...
@section('content')
  ...
  <section class="bnr_part">
    <div class="container">
      <div id="slide61" class="offset-lg-2 col-lg-8 offest-md-2 col-md-8 col-sm-12 col-12 text-center mp-0">
        ...
        <!-- <h3>Starting your diesel claims check is easy and 100% online.</h3> -->
      </div>
      ...
      <div class="offset-lg-3 col-lg-6 offest-md-2 col-md-8 col-sm-12 col-12">
        <div class="form">
          ...
          <form name="cust_info" id="cust_info" action="{{ $actionpage }}" method="post" class="pad-lef">
            ...
            <input type="hidden" name="joined_another_claim" id="joined_another_claim" value="yes" />

            <div class="row" id="slide6">
              <div class="animated-arrow d-lg-block d-md-none d-sm-block arrow" id=""> 
                <img src="{{ $resourcePath }}img/arrow.png" alt=""> </div>
              <div class="form-section text-center">
                <div class="row">
                  <div class="col-lg-12">
                    <!-- <h4>Select Mercedez-Benz Class</h4> -->
                    ...
                    <div class="offset-lg-1 col-lg-10 mb-pd text-center" style="margin-bottom: 10px; padding: 0px;"> <a href="javascript:void(0)" class="btn next012 regNextBtn"><span>Continue >> <br>
                    ...
                    <div class="fieldset-inner text-center">
                      ...
                      <div class="row custom_radio justify-content-center">
                        <div class="mr-25">
                          ...
                          <label class="label-text next02" for="named_tenant-eng"><span>England</span> </label>
                        </div>
                        <div class="">
                          <input type="radio" class="want_answer_yes" value="yes" name="purchase_finance_lease" id="named_tenant-wal">
                          <label class="label-text next02" for="named_tenant-wal"><span>Wales</span> </label>
                        </div>
                        <div class="">
              ...
              <div class="col-lg-12 p-0">
                <fieldset class="third_step form-section" data-step="3">
                  <div class="col-lg-12 col-12 text-center">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
                      <fieldset class="scheduler-border">
                        <legend class="scheduler-border">Important Claims Related Contact</legend>
