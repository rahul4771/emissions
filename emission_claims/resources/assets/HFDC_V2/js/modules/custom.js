...
$(document).ready(function() {
  ...
  $(".next02").on('click', function() {
    let diesel_purchase = $(this).parent().find("input[type='radio']").val();
    if (diesel_purchase=='yes') {
      $("html, body").animate({
          scrollTop: 100
      }, "100");
      $("#slide2, .arrow").hide();
  ...
  $(".next03").on('click', function() {
    let litre_diesel = $(this).parent().find("input[type='radio']").val();
    if (litre_diesel=='no') {  
      $("html, body").animate({
          scrollTop: 210
      }, "100");
  ...
  $("#Submitbutton").click(function() {
    ...
    // Spouses date of birth validations
    if (txtFName == "") {
      valid = false;
  ...
  /*$("#postcodevalid").on('click', function() {
      $("#postbtndiv").hide();
      $("#currentAddressCollapse").show();     
  });
  $("#address1").on('click', function() {
      $(".housedivid, #applynow03div, #next01").show();
      $("#postbtndiv").hide();
  });*/
  ...
  $("#frhdiv").on('click', function() {
      $(".hidediv").hide();
      $(".fshodiv").show();
  });
  $("#fswdiv").on('click', function() {
      $(".hidediv").show();
      $(".fshodiv").hide();
  });
