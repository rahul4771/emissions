...
use App\Http\Requests\Split_HFDC_V1;
use App\Models\User;
use Exception;


class Split_HFDC_V1_Controller extends Controller
{
    ...
    public function store( Split_HFDC_V1 $request, UserInterface $userRepo)
    { 
