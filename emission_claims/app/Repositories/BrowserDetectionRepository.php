...
use  App\Repositories\Interfaces\BrowserDetectionInterface;
 ...
 */
class BrowserDetectionRepository implements BrowserDetectionInterface
{  
    /**#@+
    ...
    {
        $this->addCustomBrowserDetection("Amazon Silk", "Silk", true);
